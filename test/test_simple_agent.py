...
response1 = basic_agent.run("你好，请介绍一下自己做")
...
# 测试4：动态添加工具
print(" === 测试4：动态添加工具 ===")
print(f"添加工具前:{basic_agent.has_tool(calculator.name)}")
basic_agent.add_tool(calculator)
print(f"添加工具后:{basic_agent.has_tool(calculator.name)}")
print(f"可用工具:{basic_agent.list_tools()}")

# 查看对话历史
print(f"\n对话历史：{len(basic_agent.get_history())} 条信息。")